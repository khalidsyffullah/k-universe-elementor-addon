...
class K_Universe_Elementor_Tab_Widget extends \Elementor\Widget_Base {
    ...
    protected function _register_controls() {
		...
		$repeater->add_control(
			'tab_title',
			[
				'label' => esc_html__( 'Title & Description', 'K_Universe-elementor-widget' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Tab Title', 'K_Universe-elementor-widget' ),
                'placeholder' => esc_html__('Tab Title', 'K_Universe-elementor-widget'),
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				],
        ...
        $repeater->add_control(
			...
			[
				'label' => esc_html__( 'Content', 'K_Universe-elementor-widget'),
				'default' => esc_html__( 'Tab Content', 'K_Universe-elementor-widget' ),
				'placeholder' => esc_html__( 'Tab Content','K_Universe-elementor-widget' ),
        ...
        $this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Tabs Items', 'K_Universe-elementor-widget' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => esc_html__( 'Default tab', 'K_Universe-elementor-widget' ),
		...
		$this->add_control(
			'view',
			[
				'label' => esc_html__( 'View', 'K_Universe-elementor-widget' ),
		...
		$this->add_control(
			'type',
			[
				'label' => esc_html__( 'Position', 'K_Universe-elementor-widget' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'horizontal',
				'options' => [
					'horizontal' => esc_html__( 'Horizontal', 'K_Universe-elementor-widget' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Alignment', 'K_Universe-elementor-widget' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'' => [
						'title' => esc_html__( 'Start', 'K_Universe-elementor-widget' ),
						'icon' => 'eicon-h-align-left',
					],
					'center' => [
						'title' => esc_html__( 'Center', 'K_Universe-elementor-widget' ),
						'icon' => 'eicon-h-align-center',
					],
					'end' => [
						'title' => esc_html__( 'End', 'K_Universe-elementor-widget' ),
						'icon' => 'eicon-h-align-right',
					],
					'stretch' => [
						'title' => esc_html__( 'Justified', 'K_Universe-elementor-widget' ),
        ...
        $this->start_controls_section(
			'section_tabs_style',
			[
				'label' => esc_html__( 'Tabs', 'K_Universe-elementor-widget' ),
		...
		$this->add_control(
			'navigation_width',
			[
				'label' => esc_html__( 'Navigation Width', 'K_Universe-elementor-widget' ),
		...
		$this->add_control(
			'border_width',
			[
				'label' => esc_html__( 'Border Width', 'K_Universe-elementor-widget' ),
				'type' => Controls_Manager::SLIDER,
		...
		$this->add_control(
			'border_color',
			[
				'label' => esc_html__( 'Border Color', 'K_Universe-elementor-widget' ),
		...
		$this->add_control(
			'background_color',
			[
				'label' => esc_html__( 'Background Color', 'K_Universe-elementor-widget' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'heading_title',
			[
				'label' => esc_html__( 'Title', 'K_Universe-elementor-widget' ),
		...
		$this->add_control(
			'tab_active_color',
			[
				'label' => esc_html__( 'Active Color', 'K_Universe-elementor-widget' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
